  ...
  test('ibare text matches the book forms when harakat are hidden', () {
    expect(
      ...
      [
        ...
        'الباب الأول: اِنْفَعَلَ يَنْفَعِلُ اِنْفِعَالًا موزونه اِنْكَسَرَ يَنْكَسِرُ اِنْكِسَارًا، وعلامته أن يكون ماضيه على خمسة أحرف بزيادة الهمزة والنون في أوله وبناؤه للمطاوعة نحو: كَسَرْتُ الزجاج فَانْكَسَرَ ذلك الزجاج',
        ...
        'الباب الخامس: تَفَعْلَى يَتَفَعْلَى تَفَعْلِيًا، موزونه: تَسَلْقَى يَتَسَلْقَى تَسَلْقِيًا، وعلامته أن يكون ماضيه على خمسة أحرف بزيادة التاء في أوله والياء في آخره، وبناؤه للازم نحو: تَسَلْقَى زيد، أي نام على قفاه، والإلحاق في هذه الملحقات إنما هو بغير التاء، مثلا الإلحاق في تَجَلْبَبَ إنما هو بتكرار الباء والتاء إنما دخلت لمعنى المطاوعة كما كانت في تَدَحْرَجَ لأن الإلحاق لا يكون في أول الكلمة بل في وسطها وآخرها على ما صرح به في شرح المفصل',
        ...
        'الباب الثاني: اِفْعَنْلَى يَفْعَنْلِي اِفْعِنْلَاءً، موزونه: اِسْلَنْقَى يَسْلَنْقِي اِسْلِنْقَاءً، وعلامته أن يكون ماضيه على ستة أحرف بزيادة الهمزة في أوله، والنون بين العين واللام والياء في آخره، وبناؤه للازم نحو: اِسْلَنْقَى زيد',
