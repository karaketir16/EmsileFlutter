  ...
  test('ibare text matches the book forms when harakat are hidden', () {
    expect(
      ...
      [
        ...
        'الباب الخامس: فَعُلَ يَفْعُلُ موزونه: حَسُنَ يَحْسُنُ، وعلامته أن يكون عين فعله مضموماً في الماضي والمضارع',
        'وبناؤه لا يكون إلا لازماً نحو: حَسُنَ زيد.',
        ...
        'وبناؤه للتعدية غالباً وقد يكون لازماً مثال المتعدي نحو: أَكْرَمَ زيد عمراً ومثال اللازم نحو: أَصْبَحَ الرجل.',
        'الباب الثاني فَعَّلَ يُفَعِّلُ تَفْعِيلًا موزونه فَرَّحَ يُفَرِّحُ تَفْرِيحًا وعلامته أن يكون ماضيه على أربعة أحرف بزيادة حرف واحد بين الفاء والعين من جنس عين فعله وبناؤه للتكثير نحو طَوَّفَ زيد الكعبة وَمَوَّتَ الإبل وَغَلَّقَ زيد الباب',
        'الباب الثالث فَاعَلَ يُفَاعِلُ مُفَاعَلَةً وَفِعَالًا موزونه قَاتَلَ يُقَاتِلُ مُقَاتَلَةً وَقِتَالًا وعلامته أن يكون ماضيه على أربعة أحرف بزيادة الألف بين الفاء والعين وبناؤه للمشاركة بين الاثنين غالباً وقد يكون للواحد نحو قَاتَلَ زيد عمراً وَقَاتَلَهُمُ الله',
        'النوع الثاني الفعل الثلاثي المزيد بحرفين وهو خمسة أبواب الباب الأول اِنْفَعَلَ يَنْفَعِلُ اِنْفِعَالًا موزونه اِنْكَسَرَ يَنْكَسِرُ اِنْكِسَارًا وعلامته زيادة الهمزة والنون في أوله وبناؤه للمطاوعة نحو كَسَرْتُ الزجاج فَانْكَسَرَ الزجاج',
        'الباب الثاني اِفْتَعَلَ يَفْتَعِلُ اِفْتِعَالًا موزونه اِجْتَمَعَ يَجْتَمِعُ اِجْتِمَاعًا وعلامته زيادة الهمزة في أوله والتاء بين الفاء والعين وبناؤه للمطاوعة أيضاً نحو جَمَعْتُ الإبل فَاجْتَمَعَتِ الإبل',
        'الباب الثالث اِفْعَلَّ يَفْعَلُّ اِفْعِلَالًا موزونه اِحْمَرَّ يَحْمَرُّ اِحْمِرَارًا وعلامته زيادة الهمزة في أوله وحرف من جنس لام فعله في آخره وبناؤه لمبالغة اللازم وقيل للألوان والعيوب نحو اِحْمَرَّ زيد وَاِعْوَرَّ زيد',
        'الباب الرابع تَفَعَّلَ يَتَفَعَّلُ تَفَعُّلًا موزونه تَكَلَّمَ يَتَكَلَّمُ تَكَلُّمًا وعلامته زيادة التاء في أوله وحرف من جنس عين فعله بين الفاء والعين وبناؤه للتكلف نحو تَعَلَّمْتُ الْعِلْمَ مسألة بعد مسألة',
        'الباب الخامس تَفَاعَلَ يَتَفَاعَلُ تَفَاعُلًا موزونه تَبَاعَدَ يَتَبَاعَدُ تَبَاعُدًا وعلامته زيادة التاء في أوله والألف بين الفاء والعين وبناؤه للمشاركة بين الاثنين فصاعداً نحو تَبَاعَدَ زيد عَنْ عمرو وَتَصَالَحَ القوم',
        'النوع الثالث الفعل الثلاثي المزيد بثلاثة أحرف وهو أربعة أبواب الباب الأول اِسْتَفْعَلَ يَسْتَفْعِلُ اِسْتِفْعَالًا موزونه اِسْتَخْرَجَ يَسْتَخْرِجُ اِسْتِخْرَاجًا وعلامته زيادة الهمزة والسين والتاء في أوله وبناؤه للتعدية غالباً وقد يكون لازماً وقيل لطلب الفعل نحو اِسْتَخْرَجَ زيد المال وَاِسْتَحْجَرَ الطين وَاِسْتَغْفَرَ الله',
        'الباب الثاني اِفْعَوْعَلَ يَفْعَوْعِلُ اِفْعِيعَالًا موزونه اِعْشَوْشَبَ يَعْشَوْشِبُ اِعْشِيشَابًا وعلامته زيادة الهمزة في أوله وحرف من جنس عين فعله والواو بين العين واللام وبناؤه لمبالغة اللازم يقال عَشُبَتِ الْأَرْضُ وَاِعْشَوْشَبَتِ الْأَرْضُ',
        'الباب الثالث اِفْعَوَّلَ يَفْعَوِّلُ اِفْعِوَّالًا موزونه اِجْلَوَّذَ يَجْلَوِّذُ اِجْلِوَّاذًا وعلامته زيادة الهمزة في أوله وواوين بين العين واللام وبناؤه لمبالغة اللازم يقال جَلَذَتِ الإبل وَاِجْلَوَّذَتِ الإبل',
        'الباب الرابع اِفْعَالَّ يَفْعَالُّ اِفْعِيلَالًا موزونه اِحْمَارَّ يَحْمَارُّ اِحْمِيرَارًا وعلامته زيادة الهمزة في أوله والألف بين العين واللام وحرف من جنس لام فعله في آخره وبناؤه لمبالغة اللازم وهو أَبْلَغُ من باب الِافْعِلَالِ نحو حَمُرَ زيد وَاِحْمَرَّ زيد وَاِحْمَارَّ زيد',
        'باب الرباعي المجرد وهو باب واحد فَعْلَلَ يُفَعْلِلُ فَعْلَلَةً وَفِعْلَالًا موزونه دَحْرَجَ يُدَحْرِجُ دَحْرَجَةً وَدِحْرَاجًا وعلامته أن يكون ماضيه على أربعة أحرف جميع حروفه أصلية وبناؤه للتعدية غالباً وقد يكون لازماً نحو دَحْرَجَ زيد الحجر وَدَرْبَخَ زيد',
        'الباب الأول فَوْعَلَ يُفَوْعِلُ فَوْعَلَةً وَفِيعَالًا موزونه حَوْقَلَ يُحَوْقِلُ حَوْقَلَةً وَحِيقَالًا وعلامته زيادة الواو بين الفاء والعين وبناؤه للازم نحو حَوْقَلَ زيد',
        'الباب الثاني فَيْعَلَ يُفَيْعِلُ فَيْعَلَةً وَفِيعَالًا موزونه بَيْطَرَ يُبَيْطِرُ بَيْطَرَةً وَبِيطَارًا وعلامته زيادة الياء بين الفاء والعين وبناؤه للتعدية فقط نحو بَيْطَرَ زيد القلم أي شَقَّهُ',
        'الباب الثالث فَعْوَلَ يُفَعْوِلُ فَعْوَلَةً وَفِعْوَالًا موزونه جَهْوَرَ يُجَهْوِرُ جَهْوَرَةً وَجِهْوَارًا وعلامته زيادة الواو بين العين واللام وبناؤه للتعدية أيضاً نحو جَهْوَرَ زيد القرآن',
        'الباب الرابع فَعْيَلَ يُفَعْيِلُ فَعْيَلَةً وَفِعْيَالًا موزونه عَثْيَرَ يُعَثْيِرُ عَثْيَرَةً وَعِثْيَارًا وعلامته زيادة الياء بين العين واللام وبناؤه للازم نحو عَثْيَرَ زيد أي طَلَعَ',
        'الباب الخامس فَعْلَلَ يُفَعْلِلُ فَعْلَلَةً وَفِعْلَالًا موزونه جَلْبَبَ يُجَلْبِبُ جَلْبَبَةً وَجِلْبَابًا وعلامته زيادة حرف واحد من جنس لام فعله في آخره وبناؤه للتعدية فقط نحو جَلْبَبَ زيد أي لَبِسَ الجلباب',
        'الباب السادس فَعْلَى يُفَعْلِي فَعْلَيَةً وَفَعْلَاءً موزونه سَلْقَى يُسَلْقِي سَلْقَيَةً وَسَلْقَاءً وعلامته زيادة الياء في آخره وبناؤه للازم فقط نحو سَلْقَى زيد أي نام على قفاه ومعنى الإلحاق اتحاد المصدرين',
        'أنواع الرباعي المزيد ثلاثة النوع الأول الرباعي المزيد بحرف وهو باب واحد تَفَعْلَلَ يَتَفَعْلَلُ تَفَعْلُلًا موزونه تَدَحْرَجَ يَتَدَحْرَجُ تَدَحْرُجًا وعلامته زيادة التاء في أوله وبناؤه للمطاوعة نحو دَحْرَجْتُ الحجر فَتَدَحْرَجَ الحجر',
        'النوع الثاني الرباعي المزيد بحرفين وهو بابان الباب الأول اِفْعَنْلَلَ يَفْعَنْلِلُ اِفْعِنْلَالًا موزونه اِحْرَنْجَمَ يَحْرَنْجِمُ اِحْرِنْجَامًا وعلامته زيادة الهمزة في أوله والنون بين العين واللام الأولى وبناؤه للمطاوعة نحو حَرْجَمْتُ الإبل فَاحْرَنْجَمَتِ الإبل',
        'الباب الثاني اِفْعَلَلَّ يَفْعَلِلُّ اِفْعِلَالًّا موزونه اِقْشَعَرَّ يَقْشَعِرُّ اِقْشِعْرَارًا وعلامته زيادة الهمزة في أوله وحرف من جنس اللام الثانية في آخره وبناؤه لمبالغة اللازم يقال قَشْعَرَ جلد الرجل وَاِقْشَعَرَّ جلد الرجل',
        'الباب الأول تَفَعْلَلَ يَتَفَعْلَلُ تَفَعْلُلًا موزونه تَجَلْبَبَ يَتَجَلْبَبُ تَجَلْبُبًا وعلامته زيادة التاء في أوله وحرف من جنس لام فعله في آخره وبناؤه للازم نحو تَجَلْبَبَ زيد',
        'الباب الثاني تَفَوْعَلَ يَتَفَوْعَلُ تَفَوْعُلًا موزونه تَجَوْرَبَ يَتَجَوْرَبُ تَجَوْرُبًا وعلامته زيادة التاء في أوله والواو بين الفاء والعين وبناؤه للازم نحو تَجَوْرَبَ زيد',
        'الباب الثالث تَفَيْعَلَ يَتَفَيْعَلُ تَفَيْعُلًا موزونه تَشَيْطَنَ يَتَشَيْطَنُ تَشَيْطُنًا وعلامته زيادة التاء في أوله وَالْيَاءِ بين الفاء والعين وبناؤه للازم نحو تَشَيْطَنَ زيد',
        'الباب الرابع تَفَعْوَلَ يَتَفَعْوَلُ تَفَعْوُلًا موزونه تَرَهْوَكَ يَتَرَهْوَكُ تَرَهْوُكًا وعلامته زيادة التاء في أوله والواو بين العين واللام وبناؤه للازم نحو تَرَهْوَكَ زيد',
        'الباب الخامس تَفَعْلَى يَتَفَعْلَى تَفَعْلِيًا موزونه تَسَلْقَى يَتَسَلْقَى تَسَلْقِيًا وعلامته زيادة التاء في أوله وَالْيَاءِ في آخره وبناؤه للازم نحو تَسَلْقَى زيد أي نام على قفاه',
        'توابع ملحقات الرباعي المزيد بابان الباب الأول اِفْعَنْلَلَ يَفْعَنْلِلُ اِفْعِنْلَالًا موزونه اِقْعَنْسَسَ يَقْعَنْسِسُ اِقْعِنْسَاسًا وعلامته زيادة الهمزة والنون وحرف من جنس لام فعله وبناؤه لمبالغة اللازم يقال قَعَسَ الرجل وَاِقْعَنْسَسَ الرجل',
        'الباب الثاني اِفْعَنْلَى يَفْعَنْلِي اِفْعِنْلَاءً موزونه اِسْلَنْقَى يَسْلَنْقِي اِسْلِنْقَاءً وعلامته زيادة الهمزة في أوله والنون بين العين واللام وَالْيَاءِ في آخره وبناؤه للازم نحو اِسْلَنْقَى زيد',
        'اعلم أن الفعل المنحصر في هذه الأبواب إما ثلاثي مجرد سالم نحو كَرُمَ أو غير سالم نحو وَعَدَ وإما ثلاثي مزيد فيه سالم نحو أَكْرَمَ أو غير سالم نحو أَوْعَدَ وإما رباعي مجرد سالم نحو دَحْرَجَ أو غير سالم نحو وَسْوَسَ وَزَلْزَلَ وإما رباعي مزيد فيه سالم نحو تَدَحْرَجَ أو غير سالم نحو تَوَسْوَسَ ويقال لها الأقسام الثمانية',
        'واعلم أن كل فعل إما صحيح وهو الذي ليس في مقابلة فائه وعينه ولامه حرف من حروف العلة نحو نَصَرَ وإما معتل وهو الذي يكون في مقابلة فائه أو عينه أو لامه حرف من حروف العلة نحو وَعَدَ وَقَالَ وَطَغَى',
        'أقسام الفعل المعتل مثال وهو الذي فاؤه حرف علة نحو وَعَدَ وَيَسَرَ وأجوف وهو الذي عينه حرف علة نحو قَالَ وَكَالَ وناقص وهو الذي لامه حرف علة نحو غَزَا وَرَمَى ولفيف وهو ما فيه حرفان من حروف العلة فالمقرون نحو طَوَى والمفروق نحو وَقَى',
        'وإما مضاعف وهو الذي عينه ولامه من جنس واحد نحو مَدَّ أصله مَدَدَ حذفت حركة الدال الأولى ثم أدغمت الدال الأولى في الثانية والإدغام إدخال أحد المتجانسين في الآخر وهو ثلاثة أنواع',
        'النوع الأول الإدغام الواجب وهو أن يكون الحرفان المتجانسان متحركين أو يكون الحرف الأول ساكناً والثاني متحركاً نحو مَدَّ يَمُدُّ مَدًّا',
        'النوع الثاني الإدغام الجائز وهو أن يكون الحرف الأول من المتجانسين متحركاً والحرف الثاني ساكناً بسكون عارض نحو لم يَمُدَّ أصله لم يَمْدُدْ فيجوز بالإدغام وبالفك',
        'النوع الثالث الإدغام الممتنع وهو أن يكون الأول من المتجانسين متحركاً والثاني ساكناً بسكون أصلي نحو مَدَدْتُ إلى مَدَدْنَ',
        'وإما مهموز وهو الذي أحد حروفه الأصلية همزة نحو أَخَذَ وَسَأَلَ وَقَرَأَ فإن كانت الهمزة في مقابلة فائه سمي مهموز الفاء نحو أَخَذَ وإن كانت في مقابلة عينه سمي مهموز العين نحو سَأَلَ وإن كانت في مقابلة لامه سمي مهموز اللام نحو قَرَأَ',
        'ويقال لهذه الأقسام الأقسام السبعة يجمعها هذا البيت صحيح مثال مضاعف أجوف ناقص لفيف مهموز والله ورسوله أعلم بالصواب النهاية',
      ],
    );
  });
